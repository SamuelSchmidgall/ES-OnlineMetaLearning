...
class CDPNet(ESNetwork):
    def __init__(self, input_size, output_size, noise_std=0.01,
        ...
        recur_ff1_meta = {
            "clip": 2, "activation": identity, "input_size": input_size, "output_size": 32}
        self.recur_plastic_ff1 = \
            NetworkModule("linear", recur_ff1_meta)
        self.params.append(self.recur_plastic_ff1)

        recur_ff3_meta = {
            "clip": 2, "activation": identity, "input_size": 32, "output_size": output_size}
        self.recur_plastic_ff3 = \
            NetworkModule("structural_simple_neuromod", recur_ff3_meta)
...
if __name__ == "__main__":
    ...
    for _i in range(es_optim.max_iterations):
        ...
        with open("reward_sp1.pkl", "wb") as f:
